...
LESSONS = [
    ("一", "1. 电源和电流（第一课时）", "1.电源和电流", "电源和电流（第一课时）"),
    ("二", "2. 电源和电流（第二课时）", "1.电源和电流", "电源和电流（第二课时）"),
    ("三", "3. 导体的电阻", "2.导体的电阻", "导体的电阻"),
    ("四", "4. 实验：导体电阻率的测量（第一课时）", "3.实验：导体电阻率的测量", "实验：导体电阻率的测量（第一课时）"),
    ("五", "5. 实验：导体电阻率的测量（第二课时）", "3.实验：导体电阻率的测量", "实验：导体电阻率的测量（第二课时）"),
    ("六", "6. 串联电路和并联电路", "4.串联电路和并联电路", "串联电路和并联电路"),
    ("七", "7. 实验：练习使用多用电表", "5.实验：练习使用多用电表", "实验：练习使用多用电表"),
    ("八", "8. 电路及其应用复习", "6.电路及其应用复习", "电路及其应用复习"),
]
...
if __name__ == "__main__":
    ...
    build(os.path.join(OUT, "第十一章_学生用作业本.pdf"),
          "第十一章 电路及其应用 · 作业本",
          "学生用 · 学习任务单 + 课后练习（含作答区，无答案）",
          use_teacher_ex=False)
    build(os.path.join(OUT, "第十一章_解析版.pdf"),
          "第十一章 电路及其应用 · 解析版",
