...
LESSONS = [
    ("一", "1. 磁场 磁感线", "1.磁场 磁感线", "磁场 磁感线"),
    ("二", "2. 磁感应强度 磁通量（第一课时）", "2.磁感应强度 磁通量", "磁感应强度 磁通量（第一课时）"),
    ("三", "3. 磁感应强度 磁通量（第二课时）", "2.磁感应强度 磁通量", "磁感应强度 磁通量（第二课时）"),
    ("四", "4. 电磁感应现象及应用（第一课时）", "3.电磁感应现象及应用", "电磁感应现象及应用（第一课时）"),
    ("五", "5. 电磁感应现象及应用（第二课时）", "3.电磁感应现象及应用", "电磁感应现象及应用（第二课时）"),
    ("六", "6. 电磁波的发现及应用", "4.电磁波的发现及应用", "电磁波的发现及应用"),
    ("七", "7. 能量量子化", "5.能量量子化", "能量量子化"),
    ("八", "8. 电磁感应与电磁波初步复习", "6.电磁感应与电磁波初步复习", "电磁感应与电磁波初步复习"),
]
...
if __name__ == "__main__":
    ...
    build(os.path.join(OUT, "第十三章_学生用作业本.pdf"),
          "第十三章 电磁感应与电磁波初步 · 作业本",
          "学生用 · 学习任务单 + 课后练习（含作答区，无答案）",
          use_teacher_ex=False)
    build(os.path.join(OUT, "第十三章_解析版.pdf"),
          "第十三章 电磁感应与电磁波初步 · 解析版",
