...
LESSONS = [
    ("一", "1. 电势能和电势（第一课时）", "1.电势能和电势", "电势能和电势（第一课时）"),
    ("二", "2. 电势能和电势（第二课时）", "1.电势能和电势", "电势能和电势（第二课时）"),
    ("三", "3. 电势差", "2.电势差", "电势差"),
    ("四", "4. 电势差与电场强度的关系", "3.电势差与电场强度的关系", "电势差与电场强度的关系"),
    ("五", "5. 电容器的电容", "4.电容器的电容", "电容器的电容"),
    ("六", "6. 带电粒子在电场中的运动（第一课时）", "5.带电粒子在电场中的运动", "带电粒子在电场中的运动（第一课时）"),
    ("七", "7. 带电粒子在电场中的运动（第二课时）", "5.带电粒子在电场中的运动", "带电粒子在电场中的运动（第二课时）"),
    ("八", "8. 静电场中的能量复习", "6.静电场中的能量复习", "静电场中的能量复习"),
]
...
if __name__ == "__main__":
    ...
    build(os.path.join(OUT, "第十章_学生用作业本.pdf"),
          "第十章 静电场中的能量 · 作业本",
          "学生用 · 学习任务单 + 课后练习（含作答区，无答案）",
          use_teacher_ex=False)
    build(os.path.join(OUT, "第十章_解析版.pdf"),
          "第十章 静电场中的能量 · 解析版",
